...
-- Migration 010: Phone-based user profiles for international tourists

-- Drop existing table if it exists (for clean migration)
DROP TABLE IF EXISTS tourist_profiles_phone CASCADE;
...
CREATE TRIGGER update_tourist_profiles_phone_updated_at
...
DO $$
BEGIN
    RAISE NOTICE '✅ Tourist Profiles (Phone-Based) Table Created!';
    RAISE NOTICE '📱 Phone-based authentication ready for international tourists';
    RAISE NOTICE '🌍 Supports international phone numbers and cross-device access';
    RAISE NOTICE '🎯 Preferences and booking history tied to phone numbers';
    RAISE NOTICE '📞 Demo profiles created for testing';
END $$; 